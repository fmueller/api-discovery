...
declare module 'express-winston' {
  ...
  namespace expressWinston {
    export interface Options {
      ...
      requestFilter?: <K extends keyof IncomingMessage>(
        req: IncomingMessage,
        propName: K
      ) => IncomingMessage[K];
      responseFilter?: <K extends keyof ServerResponse>(
        res: ServerResponse,
        propName: K
      ) => ServerResponse[K];
    ...
    export interface ExpressWinston {
      ...
      responseWhitelist: string[];
      ignoredRoutes: string[];
      defaultRequestFilter<K extends keyof IncomingMessage>(
        req: IncomingMessage,
        propName: K
      ): IncomingMessage[K];
      defaultResponseFilter<K extends keyof ServerResponse>(
        res: ServerResponse,
        propName: K
      ): ServerResponse[K];
